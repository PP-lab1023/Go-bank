...
// Store provides all functions to execute db entries and transactions
type Store struct {
	*Queries
	db *sql.DB
}
...
func (store *Store) UpdateTx(ctx context.Context, arg UpdateTxParams) (UpdateTxResult, error) {
