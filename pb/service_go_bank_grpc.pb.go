...
type GoBankClient interface {
	...
	VerifyEmail(ctx context.Context, in *pb.VerifyEmailRequest, opts ...grpc.CallOption) (*pb.VerifyEmailResponse, error)
}
...
func (c *goBankClient) VerifyEmail(ctx context.Context, in *pb.VerifyEmailRequest, opts ...grpc.CallOption) (*pb.VerifyEmailResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(pb.VerifyEmailResponse)
...
type GoBankServer interface {
	...
	VerifyEmail(context.Context, *pb.VerifyEmailRequest) (*pb.VerifyEmailResponse, error)
...
func (UnimplementedGoBankServer) VerifyEmail(context.Context, *pb.VerifyEmailRequest) (*pb.VerifyEmailResponse, error) {
...
func _GoBank_VerifyEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoBankServer).VerifyEmail(ctx, req.(*pb.VerifyEmailRequest))
	}
	return interceptor(ctx, in, info, handler)
}
